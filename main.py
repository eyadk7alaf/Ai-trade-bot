...
async def about_bot(msg: types.Message):
    about_msg = f"""
🤖  🚀 AlphaTradeAI: ثورة التحليل الكمّي في تداول الذهب! 🚀
...
1.  إشارات خماسية التأكيد (5-Tier Confirmation):
...
2.  أعلى درجات الثقة:
    لا يتم إرسال أي صفقة إلا إذا تجاوزت نسبة الثقة **85%** (90% حالياً). هذا يعني أنك تحصل على إشارات نادرة، لكنها فائقة القوة.
...
━━━━━━━━━━━━━━━
💰 حوّل التحليل إلى ربح. لا تدع الفرص تفوتك! اضغط على '💰 خطة الأسعار VIP' للاطلاع على العروض الحالية. {int(CONFIDENCE_THRESHOLD*100)}% لضمان أعلى جودة.
"""
